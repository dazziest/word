...
public class ac
{
  ...
  {
    ac localac = a(paramViewGroup, paramaf);
    localac.b = ((int)(localac.b * (1.0F / paramFloat)));
    return localac;
  }
  
  public static ac a(ViewGroup paramViewGroup, af paramaf)
  {
    return new ac(paramViewGroup.getContext(), paramViewGroup, paramaf);
  }
  ...
  {
    int i1 = z.c(paramMotionEvent);
    for (int i2 = 0; i2 < i1; i2++)
    {
      int i3 = z.b(paramMotionEvent, i2);
      float f1 = z.c(paramMotionEvent, i2);
      float f2 = z.d(paramMotionEvent, i2);
      this.f[i3] = f1;
      this.g[i3] = f2;
    }
  }
  ...
  public boolean a(int paramInt1, int paramInt2)
  {
    ...
    return a(paramInt1, paramInt2, (int)ao.a(this.l, this.c), (int)ao.b(this.l, this.c));
  }
  ...
  public boolean a(MotionEvent paramMotionEvent)
  {
    ...
    while (this.a == 1)
    {
      ...
      if ((i9 & this.p) != 0)
      {
        ...
        continue;
        int i6 = z.b(paramMotionEvent, i2);
        float f5 = z.c(paramMotionEvent, i2);
        float f6 = z.d(paramMotionEvent, i2);
        a(f5, f6, i6);
        if (this.a == 0)
        {
          int i7 = this.h[i6];
        ...
        else if (this.a == 2)
        {
          ...
          if (localView2 == this.s)
          {
            ...
            for (int i4 = 0;; i4++)
            {
              ...
              if (i4 < i3)
              {
                i5 = z.b(paramMotionEvent, i4);
                f1 = z.c(paramMotionEvent, i4);
                f2 = z.d(paramMotionEvent, i4);
                f3 = f1 - this.d[i5];
                f4 = f2 - this.e[i5];
                b(f3, f4, i5);
                if (this.a != 1) {
  ...
  public boolean a(boolean paramBoolean)
  {
    ...
    label186:
    label196:
    for (boolean bool2 = this.q.a();; bool2 = bool1)
    {
      if (!bool2)
      {
        if (!paramBoolean) {
  ...
  public void b(MotionEvent paramMotionEvent)
  {
    ...
    case 5: 
      ...
      do
      {
        ...
        do
        {
          ...
          return;
          i13 = z.b(paramMotionEvent, i3);
          f9 = z.c(paramMotionEvent, i3);
          f10 = z.d(paramMotionEvent, i3);
          a(f9, f10, i13);
          if (this.a != 0) {
            break;
          }
    ...
    case 2: 
      if (this.a == 1)
      {
        int i10 = z.a(paramMotionEvent, this.c);
        float f7 = z.c(paramMotionEvent, i10);
        float f8 = z.d(paramMotionEvent, i10);
      ...
      for (;;)
      {
        ...
        if (i1 < i8)
        {
          i9 = z.b(paramMotionEvent, i1);
          f3 = z.c(paramMotionEvent, i1);
          f4 = z.d(paramMotionEvent, i1);
          f5 = f3 - this.d[i9];
          f6 = f4 - this.e[i9];
          b(f5, f6, i9);
          if (this.a != 1) {
    ...
    case 6: 
      i4 = z.b(paramMotionEvent, i3);
      if ((this.a == 1) && (i4 == this.c))
      {
        int i5 = z.c(paramMotionEvent);
        if (i1 >= i5) {
          break label677;
        }
        int i7 = z.b(paramMotionEvent, i1);
        if (i7 == this.c) {}
        float f1;
        float f2;
        do
