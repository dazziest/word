  ...
  implements by
{
  ...
  void a(int paramInt, ae paramae)
  {
    ...
    label239:
    for (CharSequence localCharSequence1 = paramae.a(paramInt - 1);; localCharSequence1 = null)
    {
      this.b.setText(localCharSequence1);
      TextView localTextView = this.c;
      if ((paramae != null) && (paramInt < i1)) {}
      for (CharSequence localCharSequence2 = paramae.a(paramInt);; localCharSequence2 = null)
      {
        ...
        if (i2 < i1)
        {
          ...
          if (paramae != null) {
            localCharSequence3 = paramae.a(paramInt + 1);
          }
        }
  ...
  void a(ae paramae1, ae paramae2)
  {
    ...
    {
      paramae2.a(this.l);
      this.m = new WeakReference(paramae2);
    }
    if (this.a != null)
    {
      this.f = -1;
      this.g = -1.0F;
      a(this.a.getCurrentItem(), paramae2);
      requestLayout();
    }
  }
