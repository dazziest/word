  ...
  implements Runnable
{
  ...
  private void a(HttpURLConnection paramHttpURLConnection, int paramInt)
  {
    if ((300 <= paramInt) && (paramInt < 400))
    {
      ...
      if (str2 == null)
      {
        com.google.ads.util.g.c("Could not get redirect location from a " + paramInt + " redirect.");
        ((n)this.a.b.a()).a(e.d);
        a();
        return;
      }
    ...
    if (paramInt == 200)
    {
      ...
      com.google.ads.util.g.a("Response content is: " + str1);
      if (TextUtils.isEmpty(str1))
      {
        com.google.ads.util.g.a("Response message is null or zero length: " + str1);
        ((n)this.a.b.a()).a(e.b);
        a();
        return;
      }
    ...
    com.google.ads.util.g.c("Invalid response code: " + paramInt);
    ((n)this.a.b.a()).a(e.d);
    a();
  }
  ...
  private void b()
  {
    while (!this.c)
    {
      ...
      try
      {
        ...
        AdUtil.a(localHttpURLConnection, (Context)((bt)this.a.a.a()).f.a());
  ...
  private void e(HttpURLConnection paramHttpURLConnection)
  {
    ...
    {
      com.google.ads.util.g.d("Could not get timeout value: " + str, localNumberFormatException);
    }
  }
  ...
  private void i(HttpURLConnection paramHttpURLConnection)
  {
    ...
    do
    {
      ...
      {
        com.google.ads.util.g.d("Could not get refresh value: " + str, localNumberFormatException);
        return;
      }
    } while (!localw.r());
    localw.e();
  ...
  private void k(HttpURLConnection paramHttpURLConnection)
  {
    ...
    {
      com.google.ads.util.g.e("Got bad value of Doritos cookie cache life from header: " + paramHttpURLConnection.getHeaderField("X-Afma-Doritos-Cache-Life") + ". Using default value instead.");
    }
  }
  ...
  private void m(HttpURLConnection paramHttpURLConnection)
  {
    ...
    if (!TextUtils.isEmpty(str)) {
      try
      {
        ...
        {
          com.google.ads.util.g.e("Could not parse size header: " + str);
          return;
        }
        int i = Integer.parseInt(arrayOfString[0]);
        int j = Integer.parseInt(arrayOfString[1]);
        ((n)this.a.b.a()).a(new com.google.ads.g(i, j));
        return;
      }
      catch (NumberFormatException localNumberFormatException)
      {
  ...
  public void run()
  {
    ...
    {
      com.google.ads.util.g.b("Received malformed ad url from javascript.", localMalformedURLException);
      ((n)this.a.b.a()).a(e.d);
      return;
    }
    catch (IOException localIOException)
    {
      com.google.ads.util.g.b("IOException connecting to ad url.", localIOException);
      ((n)this.a.b.a()).a(e.c);
      return;
    }
    catch (Throwable localThrowable)
    {
      com.google.ads.util.g.b("An unknown error occurred in AdResponseLoader.", localThrowable);
      ((n)this.a.b.a()).a(e.d);
    }
  }
}
 ...
 * Qualified Name:     com.google.ads.a.y
