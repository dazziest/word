...
public final class AdUtil
{
  ...
  {
    if (a >= 4) {
      return n.a(paramContext, paramDisplayMetrics);
    }
  ...
  public static int a(String paramString)
  {
    ...
    {
      g.e("The Android SDK version couldn't be parsed to an int: " + Build.VERSION.SDK);
  ...
  public static String a(Map paramMap)
  {
    ...
    {
      g.d("JsonException in serialization: ", localJSONException);
    }
    return null;
  }
  ...
  public static JSONArray a(Set paramSet)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (((localObject instanceof String)) || ((localObject instanceof Integer)) || ((localObject instanceof Double)) || ((localObject instanceof Long)) || ((localObject instanceof Float))) {
        ...
        {
          g.d("Unknown map type in json serialization: ", localClassCastException2);
        }
        ...
        {
          g.d("Unknown map type in json serialization: ", localClassCastException1);
        }
      } else {
        g.e("Unknown value in json serialization: " + localObject);
      }
    }
    return localJSONArray;
  }
  ...
  public static boolean a(int paramInt1, int paramInt2, String paramString)
  {
    ...
    {
      g.b("The android:configChanges value of the com.google.ads.AdActivity must include " + paramString + ".");
      return false;
    }
    return true;
  }
  ...
  static boolean a(m paramm)
  {
    ...
    return (paramm.equals(m.e)) || (paramm.equals(m.f));
  }
  ...
  {
    if (a >= 4) {
      return n.b(paramContext, paramDisplayMetrics);
    }
