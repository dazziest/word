...
public class bd
{
  ...
  public static boolean a(ba paramba, w paramw)
  {
    ...
    if (paramba.j().a())
    {
      com.google.ads.util.g.e("AdView received a mediation response corresponding to an interstitial ad. Make sure you specify the banner ad size corresponding to the AdSize you used in your AdView  (" + localg1 + ") in the ad-type field in the mediation UI.");
      return false;
    }
    g localg2 = paramba.j().c();
    if (localg2 != localg1)
    {
      com.google.ads.util.g.e("Mediation server returned ad size: '" + localg2 + "', while the AdView was created with ad size: '" + localg1 + "'. Using the ad-size passed to the AdView on creation.");
      return false;
    }
    return true;
  }
  ...
  private boolean a(String paramString, Activity paramActivity, d paramd, bh parambh, HashMap paramHashMap, long paramLong)
  {
    synchronized (new bk(this, (ac)this.a.h().g.a(), parambh, paramString, paramd, paramHashMap))
    {
      ...
      {
        com.google.ads.util.g.a("Interrupted while waiting for ad network to load ad using adapter class: " + paramString);
        this.a.m().a(???.d());
        if ((???.b()) && (???.c()))
        {
          if (this.a.h().b()) {}
          for (localView = null;; localView = ???.e())
          {
        ...
        if (!???.b()) {
          com.google.ads.util.g.a("Timeout occurred in adapter class: " + ???.f());
        }
        ???.a();
        return false;
      }
  ...
  private void b(ba paramba, d paramd)
  {
        ...
        for (;;)
        {
          synchronized (this.e)
          {
            ...
            if (paramba.a())
            {
              ...
              com.google.ads.util.g.a("Looking to fetch ads from network: " + localk.b());
    ...
    return;
    label293:
    ((Handler)br.a().c.a()).post(new bf(this, paramba));
  }
